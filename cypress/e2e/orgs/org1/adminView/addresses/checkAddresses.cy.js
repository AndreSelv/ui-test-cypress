    ...
    Cypress.env("ORIENTATION").forEach((orientation) => {
      describe(`Device: ${size}, Orientation: ${orientation}`, () => {
        ...
        it.skip("Remove 701 Warrenville Rd Address", () => {
          ...
          organizationPage.getAddressesButton().click();
          cy.get(
        ...
        it("Add A Billing Address", () => {
          ...
          organizationPage.getAddressesButton().click();
          organizationPage.getAddButton().click({ force: true });
          organizationPage.typeAddressIntoAddressField("701 Warrenville Rd");
          cy.contains("OK").click();
          organizationPage.getBillingAddressSection().should(
            "contain",
            "701 Warrenville Rd",
          );
        });
